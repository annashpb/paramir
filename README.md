...
$ git clone https://gitlab.beetroot.se/dmitriy.olhovsky/beetroot-starter.git
...
```bash
$ in the beginning of functions.php find Text domain definition and replace 'theme_text_domain' with the text domain according to your theme name
$ find & replace 'beetroot_' and 'beetroot' in the whole theme with your theme name
...
To use phpcs you need to install phpcs as global package
